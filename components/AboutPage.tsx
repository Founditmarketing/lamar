            ...
            <section className="py-16 md:py-32 max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center">
                    <div className="relative group">
                        ...
                        {/* Quote Overlay */}
                        <div className="absolute -bottom-6 -right-4 md:-bottom-8 md:-right-8 bg-lamar-red p-5 md:p-8 rounded-xl md:rounded-2xl shadow-2xl max-w-[200px] md:max-w-xs transform md:translate-x-0">
