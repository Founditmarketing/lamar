...
export const PlaceholderPage: React.FC<PlaceholderPageProps> = ({ title }) => {
    ...
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 text-center bg-gray-50 animate-fade-in">
            <div className="w-20 h-20 bg-lamar-navy/10 rounded-full flex items-center justify-center mb-6">
                <Construction size={40} className="text-lamar-navy" />
            </div>
            ...
            <div className="h-1 w-20 bg-lamar-navy rounded-full"></div>
        </div>
    );
};
